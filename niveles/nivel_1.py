...
def nivel_1(eventos):
    ...
    bloque = pygame.Rect(200, 200, 100, 40)
    pelota = pygame.Rect(300, 400, 20, 20)
...
#---> rebote en el suelo
        ...
        config.pantalla.fill((50, 50, 50)) #dibuja todo de nuevo
        config.pantalla.blit(texto, (config.ANCHO // 2 - 60, 50)) #dibuja el texto
        pygame.draw.rect(config.pantalla, (200, 200, 50), bloque) #dibuja el bloque
